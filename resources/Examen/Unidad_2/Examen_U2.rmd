...
Otra manera de interpretar los datos es mediante un gráfico de densidad que muestra la distribución de edades por entidad federativa y sexo. Este gráfico nos permite conocer la forma de nuestra distribución.
...
# Gráficos de barras de los registros entre el mes de Enero y Septiembre
...
mtext("Meses", side = 1, line = 5, cex = 1.1)      # Eje X (más abajo)
mtext("Registros", side = 2, line = 4, cex = 1.1)  # Eje Y (más a la izquierda)
title(main = "Distribución de los registros por mes en el estado de Colima", line = 1)
```
...
mtext("Meses", side = 1, line = 5, cex = 1.1)      # Eje X (más abajo)
mtext("Registros", side = 2, line = 4, cex = 1.1)  # Eje Y (más a la izquierda)
title(main = "Distribución de los registros por mes en el estado de Guerrero", line = 1)
```
...
mtext("Meses", side = 1, line = 5, cex = 1.1)      # Eje X (más abajo)
mtext("Registros", side = 2, line = 4, cex = 1.1)  # Eje Y (más a la izquierda)
title(main = "Distribución de los registros por mes en el estado de Michoácan", line = 1)
```
...
mtext("Meses", side = 1, line = 5, cex = 1.1)      # Eje X (más abajo)
mtext("Registros", side = 2, line = 4, cex = 1.1)  # Eje Y (más a la izquierda)
title(main = "Distribución de los registros por mes en el estado de Nayarit", line = 1)
```
